...
try {
	...
	assert.equal(r.envelope.tools.length, 27, 'embedded snapshot is the 27-def allTools (17 base + 5 canvas-v2 + 5 discord)')
	...
	assert.equal(embeddedManifest().tools.length, 27)
