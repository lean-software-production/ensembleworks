...
try {
	...
	assert.equal(r.envelope.tools.length, 28, 'embedded snapshot is the 28-def allTools (18 base + 5 canvas-v2 + 5 discord)')
	...
	assert.equal(embeddedManifest().tools.length, 28)
