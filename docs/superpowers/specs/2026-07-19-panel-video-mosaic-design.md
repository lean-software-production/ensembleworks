...
**tile-size multiplier** (0.5×–2× on a geometric slider, so the 1× default sits exactly mid-track and halving mirrors doubling; amended 2026-07-20) applied on top of the
