...
- [x] CI `e2e` job green on the PR (PR #33, first run, 1m8s — visual goldens held on ubuntu within the 0.02 ratio); nightly perf job dispatchable (perf-nightly correctly skipped on the PR event)
