...
const input = (requestKey = "req-1") => ({
  ...
  workspacePath: "/tmp/workspace", workflowVersionId: "wf-7", engineUrl: "http://fabro", sourcePath: "pipeworkflow.json",
...
describe("durable fabro-workflow jobs", () => {
  ...
  it("survives reconstruction with immutable work order and origin metadata", () => {
    ...
    expect(reopened.get(made.id)).toMatchObject({
      ...
      engineUrl: "http://fabro", sourcePath: "pipeworkflow.json", createState: "pending",
