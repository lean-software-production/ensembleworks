...
export const canvasThemeStyle = {
  ...
  "--canvas-ui-shadow": "0 2px 10px color-mix(in srgb, var(--foreground) 18%, transparent)",
  "--canvas-ui-swatch-border": "color-mix(in srgb, var(--foreground) 25%, transparent)",
  "--canvas-ui-stop-inactive": "color-mix(in srgb, var(--foreground) 40%, transparent)",
