...
- Baseline without setup-fabro (`thr_5qndhzequs`): existing guidance scaffolded
  only the refactor line. Ralph required manual adaptation; review and reproduced
...
- Near miss (`thr_nt4nqdysze`): “Run the existing refactor line” selected
  assembly-lines and scaffolded nothing. An earlier routing thread failed during
