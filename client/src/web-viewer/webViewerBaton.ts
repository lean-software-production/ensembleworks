 ...
 * hold a web-viewer baton (any shape)? Split out of hideControllerCursor.ts
 ...
 */
export function hasWebViewerBaton(meta: unknown): boolean {
	if (!meta || typeof meta !== 'object') return false
	const fv = (meta as { webViewerPresent?: unknown }).webViewerPresent
